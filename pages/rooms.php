...
<body>
    <div id="user" v-cloak>
        ...
        <div class="body-wrapper" style="overflow-x: hidden !important;">
                ...
                <div class="container" style="margin-top: 110px;">
                    ...
                    <div class="_1qdp1ym">
                        <div class="_dm2bj1"><span class="_1jvg42j"><span class="_hyestb"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 14px; width: 14px; fill: currentcolor;"><path d="M15.094 1.579l-4.124 8.885-9.86 1.27a1 1 0 0 0-.542 1.736l7.293 6.565-1.965 9.852a1 1 0 0 0 1.483 1.061L16 25.951l8.625 4.997a1 1 0 0 0 1.482-1.06l-1.965-9.853 7.293-6.565a1 1 0 0 0-.541-1.735l-9.86-1.271-4.127-8.885a1 1 0 0 0-1.814 0z" fill-rule="evenodd"></path></svg></span>
                            ...
                            <span class="_1jvg42j"><button type="button" class="_11eqlma4"><span class="_9xiloll" aria-hidden="false">Tornio, Finland</span></button>
                            </span>
                        </div>
                        <div class="_88xxct">
                            <div class="_y4w03w d-flex gap-4">
                                <div class="_5kaapu _s65ijh7 d-flex gap-1 align-items-center">
                                    <span class="_14tkmhr">
                        ...
                        <div class="col-md-8">
                            ...
                            <div style="padding-top: 32px; padding-bottom: 32px;">
                                ...
                                <div class="_1vjikx5">
                                    ...
                                    <div class="_1mqc21n">
                                        <div class="_1qsawv5">Furry friends welcome</div>
                                        <div class="_1jlr81g">Bring your pets along for the stay.</div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="cnlfh1x dir dir-ltr">
                                <h2 tabindex="-1" class="_14i3z6h mb-3" style="margin-bottom: 20px;" elementtiming="LCP-target"><img class="l1li2ovm" height="25px" src="https://a0.muscache.com/im/pictures/54e427bb-9cb7-4a81-94cf-78f19156faad.jpg" alt="AirCover"></h2>
                                <div class="tgbzqhs dir dir-ltr" style="margin-top: 20px;">Every booking includes free protection from Host cancellations, listing inaccuracies, and other issues like trouble checking&nbsp;in.</div>
                                <button type="button" class="_15rpys7s">Learn more</button>
                            </div>
                            <hr>
                            <div style="padding-top: 32px; padding-bottom: 48px;">
                                ...
                                <div class="s1isfkwk dir dir-ltr">
                                    <button type="button" class="b1k5q1b3 v18vkvko dir dir-ltr">
                                    <span class="c1d1a0n6 dir dir-ltr">
                                        <span class="_15rpys7s">Show more</span>
                                    </span>
                                </button>
                                </div>
                            </div>
                            ...
                            <div style="padding-top: 12px; padding-bottom: 12px;">
                                ...
                                <div class="h1e0znt6 dir dir-ltr">
                                    <h2 id="sleeping-arrangements-title">Where you'll sleep</h2>
                                </div>
                                <div class="cob9xum dir dir-ltr" style="--carousel-wrapper-margin:-8px;">
                                    <div style="padding: 8px;">
                                        <img class="_1cb9q3xq" aria-hidden="true" alt="Bedroom" src="https://a0.muscache.com/im/pictures/miso/Hosting-54299560/original/a0ea0b2e-dd6e-42a8-ab6a-11fd4dc7b5e3.jpeg?im_w=720" style="object-fit: cover; border-radius: 8px;width: 50%;">
                                        <div class="d-grid gap-1 mt-3">
                                            <div class="_evft92"><b>Bedroom</b></div>
                                            <div class="_4zdnhq">1 double bed</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="_ud8a1c">
                                                <div class="_wgmchy" data-testid="book-it-default">
                                                        ...
                                                        <div class="d-grid mt-3">
                                                            <div class="d-flex row g-2">
                                                                ...
                                                                <div class="col-12">
                                                                    <small>Guests</small>
                                                                    <div class="dropdown ">
                                                                        <button class="btn dropdown-toggle d-block" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" style="width: calc(100% - 30px);border: 2px solid;border-radius: 9px;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                        {{total_adult_guest}} Guests
                                                                        </button>
                                                                            ...
                                                                            <li>
                                                                                <a class="dropdown-item">
                                                                                    <div role="group" class="d-flex justify-content-between px-2" aria-labelledby="GuestPicker-book_it-form-adults" aria-describedby="GuestPicker-book_it-form-adults-subtitle">
                                                                                        ...
                                                                                        <div class="_jro6t0 d-flex align-items-center">
                                                                                            <div class="d-flex gap-3 align-items-center">
                                                                                                <span v-if="no_of_adults < 1" @click.prevent class="_ul9u8c prev">-</span>
                                                                                                <span v-if="no_of_adults > 0" @click="decreaseValue('adult')" class="_ul9u8c prev">-</span>
                                                                                                <span class="counter">{{no_of_adults}}</span>
                                                                                                <span v-if="no_of_adults < apartment_details.no_of_adults" @click="increaseValue('adult')" class="_ul9u8c next">+</span>
                                                                                                <span v-if="no_of_adults >= apartment_details.no_of_adults" @click.prevent class="_ul9u8c next">+</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </a>
                                                                                <a v-if="no_of_kids > 0" class="dropdown-item">
                                                                                    <div role="group" class="d-flex justify-content-between px-2" aria-labelledby="GuestPicker-book_it-form-adults" aria-describedby="GuestPicker-book_it-form-adults-subtitle">
                                                                                        <div class="_bc4egv d-grid py-1">
                                                                                            <div class="_1ynrq4v"><b>Kids</b></div>
                                                                                            <div class="_1wh7hnv">Age 12 & below</div>
                                                                                        </div>
                                                                                        <div class="_jro6t0 d-flex align-items-center">
                                                                                            <div class="d-flex gap-3 align-items-center">
                                                                                                <span v-if="no_of_kids < 1" @click.prevent class="_ul9u8c prev">-</span>
                                                                                                <span v-if="no_of_kids > 0" @click="decreaseValue('kids')" class="_ul9u8c prev">-</span>
                                                                                                <span class="counter">{{no_of_kids}}</span>
                                                                                                <span v-if="no_of_kids < apartment_details.no_of_kids" @click="increaseValue('kids')" class="_ul9u8c next">+</span>
                                                                                                <span v-if="no_of_kids >= apartment_details.no_of_kids" @click.prevent class="_ul9u8c next">+</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </a>
                                                                                <a v-if="no_of_pets > 0" class="dropdown-item">
                                                                                    <div role="group" class="d-flex justify-content-between px-2" aria-labelledby="GuestPicker-book_it-form-adults" aria-describedby="GuestPicker-book_it-form-adults-subtitle">
                                                                                        <div class="_bc4egv d-grid py-1">
                                                                                            <div class="_1ynrq4v"><b>Pets</b></div>
                                                                                            <div class="_1wh7hnv">( ex: dogs )</div>
                                                                                        </div>
                                                                                        <div class="_jro6t0 d-flex align-items-center">
                                                                                            <div class="d-flex gap-3 align-items-center">
                                                                                                <span v-if="no_of_pets < 1" @click.prevent class="_ul9u8c prev">-</span>
                                                                                                <span v-if="no_of_pets > 0" @click="decreaseValue('pets')" class="_ul9u8c prev">-</span>
                                                                                                <span class="counter">{{no_of_pets}}</span>
                                                                                                <span v-if="no_of_kids < apartment_details.no_of_pets" @click="increaseValue('pets')" class="_ul9u8c next">+</span>
                                                                                                <span v-if="no_of_kids >= apartment_details.no_of_pets" @click.prevent class="_ul9u8c next">+</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </a>
                                                    ...
                                                    <div class="_fz3zdn w-100 mt-4">
                                                        ...
                                                        <button v-if="available" @click="move_tocheckout" type="button" class="_qqb2vcb">
                    ...
                    <section>
                        ...
                        <ul class="fhhmddr dir dir-ltr my-4">
                            <li class="f19phm7j dir dir-ltr">Response rate: <span class="ll4r2nl dir dir-ltr">100%</span></li>
                            <li class="f19phm7j dir dir-ltr">Response time: <span class="ll4r2nl dir dir-ltr">within a few hours</span></li>
                        </ul>
                        <div class="stu4mdj dir dir-ltr my-3 mb-5">
                    ...
                    <section class="row">
                        ...
                        <div v-if="apartment_details.safety_ids" class="col-md-4">
                            <div class="c1lue5su dir dir-ltr">
                                ...
                                <div v-for="(item, index) in apartment_details.safety_ids" class="d-flex gap-2 mb-2">
                                    <div aria-hidden="true" class="iv1oy2i dir dir-ltr"><i :class="item.details.icon"></i></div>
                        ...
                        <div v-if="apartment_details.apartment_cancellation_policies" class="col-md-4">
                            <div class="c1lue5su dir dir-ltr">
                                ...
                                <div v-for="(item, index) in apartment_details.safety_ids" class="d-flex gap-2 mb-2">
                                    <div aria-hidden="true" class="iv1oy2i dir dir-ltr"><i class="fa fa-shield"></i></div>
                    ...
                    <div class="modal-content" style="height: 100vh;">
                        ...
                        <div class="modal-body" style="height: calc(100vh - 100px);">
                            <video controls autoplay muted loop aria-label="A Host waves from their living room and adjusts their sofa. Another Host takes a photo in their plant-filled space. Finally, two Hosts sit beside each other and wave hello." crossorigin="anonymous" playsinline=""
                                preload="auto" style="object-fit: cover;width: 100%;height:100%; object-position: 0px 25%;"><source src="https://a0.muscache.com/v/8b/04/8b0456c7-13f8-54bc-889a-7cf549f144a3/8b0456c713f854bc889a7cf549f144a3_4000k_1.mp4?imformat=h265" type="video/mp4; codecs=hevc"><source src="https://a0.muscache.com/v/8b/04/8b0456c7-13f8-54bc-889a-7cf549f144a3/8b0456c713f854bc889a7cf549f144a3_4000k_1.mp4" type="video/mp4"></video>
                        </div>
