...
<body>
    ...
    <div class="body-wrapper">
        ...
        <main class="container" style="margin-top: 120px;max-width: 700px;">
            <div class="_vh5bhjv mt-4">
                <section>
                    <h1 tabindex="-1" class="_14i3z6h" elementtiming="LCP-target">
                        <div class="_1j8963g">Notifications</div>
                    </h1>
                </section>
                <div class="d-flex mb-4">
                    <a target="_blank" id="5928576777" aria-label="Unread notification, Please confirm your email address by clicking on the link we just emailed you. If you cannot find the email, you can request a new confirmation email or change your email address., September 14, 2022"
                        href="" class="_11eqlma4">
                        <div class="_1nlq2tac d-flex gap-4">
                            <div class="_1hctbk4">
                                <img class="_91slf2a" style="object-fit:cover;border-radius:50%;" aria-hidden="true" alt="" width="40px" height="40px" src="https://a0.muscache.com/airbnb/static/logos/belo_babu-f2e24a0d05d5e86c94a14dbd7dc6cf4c.png">
                            </div>
                            <div class="_1xs0m0s">
                                <div class="_4n554k">Please confirm your email address by clicking on the link we just emailed you. If you cannot find the email, you can request a new confirmation email or change your email address.</div>
                                <div class="_ceboi0">September 14, 2022</div>
                            </div>
                        </div>
                    </a>
                    <div class="_1gtwurf"><button aria-label="Dismiss" aria-describedby="5928576777" type="button" class="_oda838"><span class="_e296pg"><span><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="display:block;fill:none;height:16px;width:16px;stroke:currentColor;stroke-width:3;overflow:visible" aria-hidden="true" role="presentation" focusable="false"><path d="m6 6 20 20"></path><path d="m26 6-20 20"></path></svg></span></span></button></div>
                </div>
                <div class="d-flex mb-4">
                    <a target="_blank" id="5928576777" aria-label="Unread notification, Please confirm your email address by clicking on the link we just emailed you. If you cannot find the email, you can request a new confirmation email or change your email address., September 14, 2022"
                        href="" class="_11eqlma4">
