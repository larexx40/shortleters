         ...
         <!--password Modal -->
            <div class="modal fade" id="password" tabindex="-1" aria-labelledby="password-modal" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                     <div class="modal-header">
                     <h5 class="modal-title" id="password-modal">Preferred Lanugage</h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                     </div>
                     <div class="modal-body">
                        <form action="" method="">
                           <div class="form-input">
                              <label for="prev-password" class="form-label">Email address</label>
                              <input type="password" class="form-control" id="prev-password">
                           </div>
                           <div class="form-input">
                              <label for="new-password" class="form-label">Email address</label>
                              <input type="password" class="form-control" id="new-password">
                           </div>
                           <div class="form-input">
                              <label for="repeat-password" class="form-label">Email address</label>
