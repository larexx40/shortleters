                ...
                <div style="height: 100%;display:flex;align-items: center;justify-content: center;">
                    ...
                    <div class=" hovvvv justify-content-evenly">
                        ...
                        <div class="d-flex justify-content-evenly" style="padding-top: 10px;">
                            <a href="./description.html" class="btn _kaq6tx w-120" style="background-color: transparent;background-image: none !important;color: black;">Back</a>
                            <a href="./price.html" class="btn _kaq6tx  w-120" style="background-color: #dddddd;background-image: none !important;">Next</a>
                        </div>
