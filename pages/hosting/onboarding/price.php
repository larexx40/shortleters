...
<style>
    ...
    @media (max-width: 769px) {
        .col-md-6.video-container.p-0.pt-md-5.position-relative {
    ...
    ._16gvswn9 {
        ...
        animation-name: keyframe_ey5qgs !important;
    }
</style>
            ...
            <div class="col-md-6 video-container p-0 pt-md-5 position-relative">
                <div style="height: 100%;display:flex;align-items: center;justify-content: center;">
                    <ul class="question-tag px-4">
                        ...
                        <div class="card  my-3">
                            <div class="card-body">
                                Offer a 20% discount for your first 3 guests to help you get booked faster. Learn more
                            </div>
                        </div>
                    ...
                    <div class=" hovvvv justify-content-evenly">
                        ...
                        <div class="d-flex justify-content-evenly" style="padding-top: 10px;">
                            <a href="./description_title.php" class="btn _kaq6tx w-120" style="background-color: transparent;background-image: none !important;color: black;">Back</a>
                            <a href="./legal.php" class="btn _kaq6tx  w-120" style="background-color: #dddddd;background-image: none !important;">Next</a>
                        </div>
