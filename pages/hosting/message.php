...
<body>
    ...
    <div class="body-wrapper">
                ...
                <div class="second-div">
                    <div class="end-tabs">
                        <ul class="host d-none d-lg-flex gap-5">
                            ...
                            <li>
                                <a href="./message.php" class="host-link active"><span>Inbox</span></a>
                            </li>
                            <li>
        ...
        <main class="container-fluid p-0 mx-0 justify-content-center row" style="margin-top: 80px;">
            <div class="d-flex my-3 gap-3 align-items-center" style="font-size:20px ;">
                <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: none; height: 22px; width: 22px; stroke: currentcolor; stroke-width: 4; overflow: visible;"><g fill="none" fill-rule="nonzero"><path d="m2 16h28"></path><path d="m2 24h28"></path><path d="m2 8h28"></path></g></svg>
                <b>All Messages</b>
            </div>
            <div class="d-flex mb-4">
                <div class="form w-100">
                    <input placeholder="Search inbox..." aria-label="Search" name="inbox_query" class="_1oynp31" id="inbox-query" autocomplete="off" type="text" aria-describedby="" value="">
                </div>
            ...
            <div class="container">
                <div class="_1j258h3">
                    <div class="_1mk0p35">
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 32px; width: 32px; fill: rgb(34, 34, 34);"><path d="M25 2a5 5 0 0 1 4.995 4.783L30 7v14a5 5 0 0 1-4.783 4.995L25 26h-4.845L16 31.08 11.844 26H7a5 5 0 0 1-4.981-4.563l-.014-.22L2 21V7a5 5 0 0 1 4.783-4.995L7 2h18zm0 2H7a3 3 0 0 0-2.995 2.824L4 7v14a3 3 0 0 0 2.824 2.995L7 24h5.792L16 27.921 19.208 24H25a3 3 0 0 0 2.995-2.824L28 21V7a3 3 0 0 0-2.824-2.995L25 4zm-3 4.586L23.414 10 14 19.414 8.586 14 10 12.586l4 3.999 8-8z"></path></svg>
                    </div>
                    <div class="_y5gfjh">No new messages</div>
                    <div class="_fmrtc1">If you're looking for a message, check the archive.</div>
                    <div class="_1itpe9r">
                        <button id="no-results-button" type="button" class="_1ku51f04">Go to archive</button>
                    </div>
                </div>
            </div>
        </main>
        ...
        <footer class="pt-5 mb-0 mt-0 position-static d-none d-md-block" style="background-color: #F7F7F7 !important;border-top: 1px solid #DDDDDD !important;">
