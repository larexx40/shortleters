...
<body>
    <div class="body-wrapper">
                ...
                <div class="second-div">
                    <div class="end-tabs">
                        <ul class="host d-none d-lg-flex gap-5">
                            <li>
                                <a href="./index.html" class="host-link active"><span>Today</span></a>
                            </li>
                            <li>
        ...
        <main class="container-fluid p-0 mx-0 justify-content-center row" style="margin-top: 80px">
            <div class="_7qxrko1" style="background-image: linear-gradient(to right, #7120a6, #cf2479)">
                <div class="_1aryjwh">
                    <div class="_dmn8hc">
                        <h1 class="_16pg94n">
                            <div class="_goqbqk">
                        ...
                        <div class="_17ctt5">
                            <div class="_1b6k6qy">
                                <a href="../notifications.html" class="_11eqlma4"><svg
											viewBox="0 0 32 32"
											xmlns="http://www.w3.org/2000/svg"
											aria-hidden="true"
											role="presentation"
