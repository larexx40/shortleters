...
<body>
    ...
    <div class="body-wrapper">
        ...
        <main class="p-0 mx-0 justify-content-center row" style="margin-top: 80px;">
            ...
            <div class=" px-5 my-5">
                <div id="FMP-target mb-5">
                    <h2><b> Reservations </b></h2>
                </div>
                <br>
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="border-bottom: 1px solid #d6d6d6;">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Uncompleted</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Cancel</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-contact-tab1" data-bs-toggle="pill" data-bs-target="#pills-contacttt" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">All</button>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <br>
                        <section role="status" class="iqzda4f i144hzgs dir d-flex">
                            <div class="mx-2">
                                <div class="rounded-circle c1mzlq0d" style="background-color:#428bff;"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: currentcolor;"><path d="M8.8 0v.991l.11.017a5.22 5.22 0 0 1 2.972 1.663 5.31 5.31 0 0 1 1.346 3.39l.002.148v4.328l1.482 2.243a.531.531 0 0 1-.377.819l-.059.002h-4.202v.176c0 .538-.204 1.054-.571 1.444-.367.39-.868.621-1.4.648L8 15.872c-.55 0-1.078-.22-1.467-.614a2.105 2.105 0 0 1-.608-1.48V13.6H1.724a.52.52 0 0 1-.447-.253.531.531 0 0 1-.019-.517l.03-.05 1.482-2.244V6.2l.002-.148C2.846 3.476 4.744 1.37 7.2.99V0z"></path></svg></div>
                            </div>
                            <div class="mbv7i5o dir dir-ltr">
                                <h2 tabindex="-1" class="_14i3z6h">
                                    <div class="small" style="color:#222222;font-size: 15px;font-weight: 800;">Health and safety guidance for Hosts and guests</div>
                                </h2>
                                <small style="color:#717171;">As travel picks up again, we want to help our Hosts and guests remain safe. Please follow the health and safety guidance if you have any interaction with guests. <a target="_blank" class="d-block" href="/help/article/2839" class="_7c704qi">Review the guidelines</a></small>
                            </div>

                        </section>
                        <div class="_1xh9y8t">
                            <div class="_y3y4ly d-grid">
                                <div class="_1p7iugi text-center">You have no upcoming reservations</div>
                                <button type="button" class="_15rpys7s text-center">See all reservations</button></div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="pills-contacttt" role="tabpanel" aria-labelledby="pills-contact-tab1">...</div>
                </div>
            </div>
