...
<body>
    ...
    <div class="body-wrapper">
                ...
                <div class="row col-12 m-0 align-items-center justify-content-between justify-content-md-around">
                    <div class="p-0 col-md-1 col-lg-2 logo text-md-start d-none d-md-inline-flex">
                        ...
                        <div class="sm-screen-logo d-lg-none">
                            <a href="#">
                            <img style="width:100%;" src="../assets/images/GREEN_LOGO_HORIZONTAL_1.png" /> <img style="width:100%;" src="../assets/images/GREEN_LOGO_VERTICAL_1.png" />
                            </a>
                        </div>
                    </div>
        ...
        <main class="container justify-content-center row" style="margin: auto;margin-bottom: 60px;margin-top: 120px;">
            <div class="my-4">
                <h2><b>Account Settings</b></h2>
                <b>Okeke Johnpaul, okekejohnpaul12@gmail.com · <a href="profile.php">Go to profile</a></b>
            </div>
