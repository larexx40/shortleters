<?php
    ...
    if ($method == 'GET') {
        ...
        if (!empty($search) && $search != "" && $search != " "){
            ...
            $query = "SELECT tracking_history.id, tracking_history.orderef_no, tracking_history.orderstatus, tracking_history.detail, tracking_history.created_at, tracking_history.updated_at, tracking_history.user_id, tracking_history.logistics_id FROM `tracking_history` LEFT JOIN users ON tracking_history.user_id = users.id WHERE detail LIKE ? users.fname LIKE ? users.lname LIKE ?";
            ...
            // Output page
            $query = "SELECT tracking_history.id, tracking_history.orderef_no, tracking_history.orderstatus, tracking_history.detail, tracking_history.created_at, tracking_history.updated_at, tracking_history.user_id, tracking_history.logistics_id FROM `tracking_history` LEFT JOIN users ON tracking_history.user_id = users.id WHERE detail LIKE ? users.fname LIKE ? users.lname LIKE ? LIMIT ?, ?";
            ...
            $query = "SELECT * FROM `tracking_history`";
            $getSearchPages = $connect->prepare($query);
            $getSearchPages->execute();
            $result = $getSearchPages->get_result();
            $num_row = $result->num_rows;
            ...
            // Output page
            $query = "SELECT * FROM `tracking_history` LIMIT ?, ?";
            $getAll = $connect->prepare($query);
