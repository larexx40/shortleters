<?php
    ...
    if ($method == 'GET') {
        ...
        if (empty($apartment_id) ){
            ...
            $errordesc = "Apartment inputs are required";
            $linktosolve = 'https://';
        ...
        $query = "SELECT amenities_id FROM `apartments` WHERE apartment_id = ?";
        ...
        if ( $num_row > 0 ){
            ...
            if ($amenities_ids){
                ...
                $amenities_id_name = $amenities_ids;
            }

            $data = $amenities_id_name;
