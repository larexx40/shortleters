    ...
    if($method =='GET'){
        ...
        if($status > 0){
            ...
            if (!empty($search) && $search!="" && $search!=' '){
                ...
                $searchParam = "%{$search}%";
                $searchQuery = "SELECT `id`, `add_chrg_id`, `name`, `description`, `status` FROM `additional_charge` 
                ...
                //get without search
                $sqlQuery = "SELECT `id`, `add_chrg_id`, `name`, `description`, `status` FROM `additional_charge` 
                            WHERE `status` =?";
            ...
            if (!empty($search) && $search!="" && $search!=' '){
                ...
                $sqlQuery = "SELECT `id`, `add_chrg_id`, `name`, `description`, `status` FROM `additional_charge`  ORDER BY id DESC LIMIT ?,?";
                $stmt= $connect->prepare($sqlQuery);
