    ...
    if ($method == 'GET') {
        ...
        if (!empty($search) && $search != "" && $search != " "){
            ...
            if ( $status !== "" && $status !== " "){
                ...
                $query = "SELECT * FROM `termiapidetails` WHERE status = ? AND (`name` LIKE ? OR `sendfrom` LIKE ? )";
                ...
                // Output page
                $query = "SELECT * FROM `termiapidetails` WHERE status = ? AND (`name` LIKE ? OR `sendfrom` LIKE ?) LIMIT ?, ?";
                ...
                // get the total number of pages
                $query = "SELECT * FROM `termiapidetails` WHERE `name` LIKE ? OR `sendfrom` LIKE ? ";
                $getSearchPages = $connect->prepare($query);
                ...
                // Output page
                $query = "SELECT * FROM `termiapidetails` WHERE `name` LIKE ? OR `sendfrom` LIKE ? LIMIT ?, ?";
                $getAll = $connect->prepare($query);
            ...
            if ( $status !== "" && $status !== " "){
                $query = "SELECT * FROM `termiapidetails` WHERE status = ?";
                $getSearchPages = $connect->prepare($query);
                ...
                // Output page
                $query = "SELECT * FROM `termiapidetails` WHERE status = ? LIMIT ?, ?";
                $getAll = $connect->prepare($query);
                ...
                $query = "SELECT * FROM `termiapidetails`";
                $getSearchPages = $connect->prepare($query);
                $getSearchPages->execute();
                $result = $getSearchPages->get_result();
                $total_num_row = $result->num_rows;
                ...
                // Output page
                $query = "SELECT * FROM `termiapidetails` LIMIT ?, ?";
                $getAll = $connect->prepare($query);
