<?php
    ...
    if ($method == 'POST') {
        ...
        if(empty($name) || empty($username) || empty($sendFrom)){
            ...
            //update using id
            $sql = "UPDATE `kudiapidetails` SET `sendfrom`= ?,`username`= ?,`name`= ? WHERE id = ?";
            $stmt = $connect->prepare($sql);
            $stmt->bind_param('ssss', $sendFrom, $username, $name, $id);
            $stmt->execute();
