    ...
    if ($method == 'GET') {
        ...
        if ($num_row > 0){
            ...
            while($row = $result->fetch_assoc()){
                ...
                $canc_pol_id = $row['canc_pol_id'];
                $canc_pol_name =  getNameFromField($connect, "cancellation_policy", "canc_pol_id", $canc_pol_id);
                ...
                array_push($allCancellation, array(
                    'id' => $row['apart_canc_pol_id'],
                    'aprtment_id' => $aprtment_id,
                    'aprtment_name' => ( $aprtment_name )? $aprtment_name: null,
                    'canc_pol_id' => $canc_pol_id,
                    'canc_pol_name' => ( $canc_pol_name )? $canc_pol_name: null,
