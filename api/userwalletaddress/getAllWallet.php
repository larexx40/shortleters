<?php
    ...
    if ($method == 'GET') {
        ...
        WHERE
            users.lname LIKE ? OR users.fname LIKE ? OR coinproducts.name LIKE ? OR memo LIKE ? ";
            $getSearchPages = $connect->prepare($query);
            $getSearchPages->bind_param("ssss", $searching, $searching, $searching, $searching);
        ...
        LEFT JOIN coinproducts ON userwalletaddresses.producttrackid = coinproducts.producttrackid
        WHERE
            users.lname LIKE ? OR users.fname LIKE ? OR coinproducts.name LIKE ? OR memo LIKE ? LIMIT ?, ?";
