<?php
    ...
    if ($method == 'GET') {
        ...
        $query = "SELECT highlights_ids FROM `apartments` WHERE apartment_id = ?";
        ...
        if ( $num_row > 0 ){
            ...
            $highlights_ids = ($row["highlights_ids"])? explode(",", $row["highlights_ids"]) : false;
            $highlights_id_name = [];
            if ($highlights_ids){
                ...
                $highlights_id_name = $highlights_ids;
            }

            $data = $highlights_id_name;
