        ...
        if (!empty($search) && $search != "" && $search != " "){
            ...
            $query = "SELECT
                ...
                WHERE
                    ...
                    ) AND products.category_id = ? AND products.status = ? ";
            $getSearchPages = $connect->prepare($query);
            $getSearchPages->bind_param("ssssssss", $searching, $searching, $searching, $searching, $searching, $searching, $categoryid, $status);
            ...
            $getAll->bind_param("ssssssssss", $searching, $searching, $searching, $searching, $searching, $searching, $categoryid, $status, $offset, $no_per_page);
            $getAll->execute();
            ...
            $query = "SELECT
                    ...
                    $getAll = $connect->prepare($query);
                    $getAll->bind_param("ss",$categoryid, $status);
                    $getAll->execute();
                    $result = $getAll->get_result();
                    $total_num_row = $result->num_rows;
                    $total_pg_found =  ceil($total_num_row / $no_per_page);  
