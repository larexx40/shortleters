                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Apartments by category</h3>
                                                <div class="nk-block-des text-soft">
                                                    <p>Here is our various Apartments in this category.</p>
                                                </div>
                                    ...
                                    <div class="nk-block">
                                        <div class="card card-bordered card-stretch">
                                            <div class="card-inner-group">
                                                    ...
                                                    <div v-if="all_apartments" class="card-inner p-0">
                                                        <div class="nk-tb-list nk-tb-ulist">
                                                            <div class="nk-tb-item nk-tb-head">
                                                                ...
                                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Location</span></div>
                                                            ...
                                                            <div v-for="(item, index) in all_apartments" class="nk-tb-item">
                                                                ...
                                                                <div class="nk-tb-col">
                                                                    <span>{{item.apartment_state}}, {{item.apartment_country}} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                                </div>
                                                                <div class="nk-tb-col">
                                                                    <span>{{item.availability}} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                                </div>
                                                ...
                                                <!-- .card-inner -->
                                                <div v-if="all_apartments" class="card-inner">
