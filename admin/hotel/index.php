                                                ...
                                                <div class="card card-bordered card-full">
                                                    ...
                                                    <ul class="nk-activity">
                                                        <li class="nk-activity-item">
                                                            <div class="nk-activity-media user-avatar bg-success"><img src="../imagess/avatar/c-sm.jpg" alt=""></div>
                                                        ...
                                                        <li class="nk-activity-item">
                                                            <div class="nk-activity-media user-avatar bg-purple"><img src="../imagess/avatar/d-sm.jpg" alt=""></div>
                                                            <div class="nk-activity-data">
