...
<body class="nk-body bg-lighter npc-general has-sidebar ">
    <div id="admin">
                                ...
                                <div class="nk-content-body">
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Paystack</h3>
                                                        ...
                                                        <ul class="nk-block-tools g-3">
                                                            <li>
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="default-04" @keyup='getAllPaystack(4)' v-model ='search' placeholder="Quick search by id">
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="drodown">
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-tb-list is-separate is-medium mb-3">
                                            ...
                                            <div v-if= 'payStacks' v-for ='(item, index) in payStacks' class="nk-tb-item">
                                                <!-- <div class="nk-tb-col nk-tb-col-check">
                                                    <div class="custom-control custom-control-sm custom-checkbox notext">
                                                    ...
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li>
                                                            <div class="drodown me-n1">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li @click.prevent = 'getPayStaskByid(item.id)'><a data-bs-toggle="modal" href="#viewModal"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                                        <li @click.prevent = 'changePaystackStatus(item.id)' v-if='item.status === "Inactive" || item.status == "0"'><a href="#"><em class="icon ni ni-report-profit"></em><span>Set Active</span></a></li>
                                                                        <li @click.prevent = 'changePaystackStatus(item.id)' v-if='item.status === "Active" || item.status == "1" ' ><a href="#"><em class="icon ni ni-report-loss"></em><span>Set Inactive</span></a></li>
                                                                        <li @click.prevent = 'getPayStaskByid(item.id)'><a data-bs-toggle="modal" href="#editModal"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
		...
		<div class="modal fade " id="addPaystacModal" style="padding-left: 0px;" aria-modal="true" role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Add PayStack</h5>
					<a href="#" class="close" data-bs-dismiss="modal" aria-label="Close"><em class="icon ni ni-cross"></em></a>
				</div>
				<div class="modal-body">
					<form action=""  @submit.prevent='addPayStack' id= 'addLocation'>
						...
						<div class="form-group"><button data-bs-dismiss="modal" type="submit" class="btn btn-lg btn-primary">Add PayStack</button></div>
					</form>
				</div>
		...
		<div  class="modal fade" tabindex="-1" id="viewModal" aria-modal="true" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div v-if='payStack_details' class="modal-body">
						<div class="card h-100">
							
							<div class="nk-tb-list is-compact">
								<div class="nk-tb-item nk-tb-head">
									<div class="nk-tb-col"><span>Name</span></div>
									<div class="nk-tb-col text-end" ><span >{{payStack_details.name}}</span></div>
								</div><!-- .nk-tb-head -->
								...
								<div class="nk-tb-item">
									...
									<div class="nk-tb-col text-end">
										<span class="tb-sub tb-amount" ><span>{{payStack_details.apikey}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
                                <div class="nk-tb-item">
									<div class="nk-tb-col">
									...
									<div class="nk-tb-col text-end">
										<span class="tb-sub tb-amount" ><span>{{payStack_details.secretekey}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
								<div class="nk-tb-item">
									<div class="nk-tb-col">
									...
									<div class="nk-tb-col text-end">
										<span v-if='payStack_details.status === "active" || payStack_details.status === "Active" || payStack_details.status == "1" ' class="text-success" ><span>{{payStack_details.status}}</span></span>
                                        <span v-if='payStack_details.status === "inactive" || payStack_details.status === "Inactive" || payStack_details.status == "0" ' class="text-danger" ><span>{{payStack_details.status}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
								<!-- .nk-tb-item -->
							</div><!-- .nk-tb-list -->
        ...
        <div class="modal fade " id="editModal" style="padding-left: 0px;" aria-modal="true" role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Update PayStack</h5>
					<a href="#" class="close" data-bs-dismiss="modal" aria-label="Close"><em class="icon ni ni-cross"></em></a>
				</div>
				<div class="modal-body">
					<form action=""  @submit.prevent='updatePayStack()' id= 'addLocation'>
						<div class="form-group">
						<label class="form-label" for="full-name">Name</label>
						<div class="form-control-wrap"><input type="text" v-if='payStack_details' v-model="payStack_details.name" class="form-control" id="full-name" required=""></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="">Api Key</label>
						<div class="form-control-wrap"><input type="text" v-if='payStack_details' v-model="payStack_details.apikey" class="form-control" id="email-address" required=""></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="phone-no">Secret Key</label>
						<div class="form-control-wrap"><input type="text" v-if='payStack_details' v-model="payStack_details.secretekey" class="form-control" ></div>
						</div>
