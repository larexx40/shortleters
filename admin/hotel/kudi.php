    ...
    <div id="admin">
                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Kudi</h3>
                                                        ...
                                                        <ul class="nk-block-tools g-3">
                                                            <li>
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="default-04" @keyup='getAllKudi(4)' v-model ='search' placeholder="Quick search by id">
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="drodown">
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-tb-list is-separate is-medium mb-3">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col"><span class="d-none d-sm-block">Send from</span></div>
                                            ...
                                            <div v-if= 'kudis' v-for ='(item, index) in kudis' class="nk-tb-item">
                                                <!-- <div class="nk-tb-col nk-tb-col-check">
                                                    <div class="custom-control custom-control-sm custom-checkbox notext">
                                                ...
                                                <div class="nk-tb-col tb-col-md">
                                                    <span class="tb-sub">{{item.username}}</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-md">
		...
		<div class="modal fade " id="addPaystacModal" style="padding-left: 0px;" aria-modal="true" role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Add Kudi</h5>
					<a href="#" class="close" data-bs-dismiss="modal" aria-label="Close"><em class="icon ni ni-cross"></em></a>
				</div>
				<div class="modal-body">
					<form action=""  @submit.prevent='addKudi()' id= 'addLocation'>
						...
						<div class="form-control-wrap"><input type="text" v-model= "apiUsername" class="form-control" id="email-address" required=""></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="phone-no">Send From</label>
						<div class="form-control-wrap"><input type="text" v-model= "sendFrom" class="form-control" ></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="">Password</label>
						<div class="form-control-wrap"><input type="password" v-model= "apiPassword" class="form-control" ></div>
						</div>
						<div class="form-group"><button data-bs-dismiss="modal" type="submit" class="btn btn-lg btn-primary">Add Kudi</button></div>
					</form>
				</div>
		...
		<div  class="modal fade" tabindex="-1" id="viewModal" aria-modal="true" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Kudi Details</h5>
						<a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
							<em class="icon ni ni-cross"></em>
						</a>
					</div>
					<div v-if='kudi_details' class="modal-body">
						<div class="card h-100">
							
							<div class="nk-tb-list is-compact">
								<div class="nk-tb-item nk-tb-head">
									<div class="nk-tb-col"><span>Name</span></div>
									<div class="nk-tb-col text-end" ><span >{{kudi_details.name}}</span></div>
								</div><!-- .nk-tb-head -->
								
								<div class="nk-tb-item">
									<div class="nk-tb-col">
										<span class="tb-sub"><span>Username</span></span>
									</div>
									<div class="nk-tb-col text-end">
										<span class="tb-sub tb-amount" ><span>{{kudi_details.username}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
                                <div class="nk-tb-item">
									<div class="nk-tb-col">
									...
									<div class="nk-tb-col text-end">
										<span class="tb-sub tb-amount" ><span>{{kudi_details.sendfrom}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
								<div class="nk-tb-item">
									<div class="nk-tb-col">
									...
									<div class="nk-tb-col text-end">
										<span v-if='kudi_details.status === "active" || kudi_details.status === "Active" || kudi_details.status == "1" ' class="text-success" ><span>{{kudi_details.status}}</span></span>
                                        <span v-if='kudi_details.status === "inactive" || kudi_details.status === "Inactive" || kudi_details.status == "0" ' class="text-danger" ><span>{{kudi_details.status}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
                                <div class="nk-tb-item">
									<div class="nk-tb-col">
										<span class="tb-sub"><span>Password</span></span>
									</div>
									<div class="nk-tb-col text-end">
										<span class="tb-sub tb-amount" ><span>{{kudi_details.password}}</span></span>
									</div>
								</div><!-- .nk-tb-item -->
								<!-- .nk-tb-item -->
							</div><!-- .nk-tb-list -->
        ...
        <div class="modal fade " id="editModal" style="padding-left: 0px;" aria-modal="true" role="dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Update Kudi</h5>
					<a href="#" class="close" data-bs-dismiss="modal" aria-label="Close"><em class="icon ni ni-cross"></em></a>
				</div>
				<div class="modal-body">
					<form action=""  @submit.prevent='updateKudi()' id= 'addLocation'>
						<div class="form-group">
						<label class="form-label" for="full-name">Name</label>
						<div class="form-control-wrap"><input type="text" v-if='kudi_details' v-model="kudi_details.name" class="form-control" id="full-name" required=""></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="">Username</label>
						<div class="form-control-wrap"><input type="text" v-if='kudi_details' v-model="kudi_details.username" class="form-control" id="email-address" required=""></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="phone-no">Send From</label>
						<div class="form-control-wrap"><input type="text" v-if='kudi_details' v-model="kudi_details.sendfrom" class="form-control" ></div>
						</div>
						<div class="form-group">
						<label class="form-label" for="">Password</label>
						<div class="form-control-wrap"><input type="password" v-if='kudi_details' v-model="kudi_details.password" class="form-control" ></div>
						</div>
