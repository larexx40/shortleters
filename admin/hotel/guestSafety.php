                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Guest Safety</h3>
                                                <div class="nk-block-des text-soft">
                                                    <p>Here are security mechanisms in your shortlet.</p>
                                                </div>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a data-bs-toggle="modal" href="#add-stock"><span>Add Guest Safety</span></a></li>
                                                                                        ...
                                                                                        <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                                            ...
                                                                                            <div class="dropdown-body dropdown-body-rg">
                                                                                                <div class="row gx-6 gy-3">
                                                                                                    ...
                                                                                                    <div class="col-12">
                                                                                                        <div class="form-group">
                                                                                                            <button @click.prevent='log()' type="button" class="btn btn-secondary">Filter</button>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                    ...
                                                    <div class="card-search search-wrap" data-search="search">
                                                        <div class="card-body">
                                                            <div class="search-content">
                                                                ...
                                                                <input type="text" class="form-control border-transparent form-focus-none"  @keyup='getAllGuestSafety(4)' v-model ='search' placeholder="Search by product name or id">
                                                                <button class="search-submit btn btn-icon"><em class="icon ni ni-search"></em></button>
                                                            </div>
                                                        </div>
                                                    </div><!-- .card-search -->
                                                </div><!-- .card-inner -->
                                                <div v-if="guestSafeties" class="card-inner p-0">
                                                    <div class="nk-tb-list nk-tb-ulist">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div class="nk-tb-col"><span class="sub-text">Guest Safety Name</span></div>
                                                        ...
                                                        <div v-for="(item, index) in guestSafeties" class="nk-tb-item">
                                                            <!-- <div class="nk-tb-col nk-tb-col-check">
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li @click.prevent = 'changeGuestSafetyStatus(item.guestSafetyid, 1)' v-if='item.statusCode == 0 '><a href="#"><em class="icon ni ni-report-profit"></em><span>Set Active</span></a></li>
                                                                                    <li @click.prevent = 'changeGuestSafetyStatus(item.guestSafetyid, 0)' v-if='item.statusCode == 1  ' ><a href="#"><em class="icon ni ni-report-profit"></em><span>Set Inactive</span></a></li>
                                                                                    <li @click.prevent= 'deleteByid(item.guestSafetyid)'><a href="#"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="add-stock">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                    <div class="modal-body modal-body-md">
                        <h5 class="modal-title">Add Guest Safety</h5>
                        <form @submit.prevent="addGuestSafety" class="mt-2">
                            <div class="row g-gs">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-add"> Name</label>
                                        <input v-model="name" type="text" class="form-control" id="product-name-add" placeholder="Guest Safety">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-add"> Icon</label>
                                        <input v-model="icon" type="text" class="form-control" id="icon" placeholder="icon ">
                                    </div>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button class="btn btn-primary" data-bs-dismiss="modal">Add Guest Safety</button>
                                        </li>
                                        <li>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit-stock">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                    <div class="modal-body modal-body-md">
                        <h5 class="modal-title">Edit Guest Safety</h5>
                        <form @submit.prevent="updateGuestSafety"  action="#" class="mt-2">
                            <div v-if='itemDetails' class="row g-gs">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-add"> Icon</label>
                                        <input v-model="itemDetails.icon" type="text" class="form-control" id="icon" placeholder="icon ">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-edit"> Description</label>
                                        <input type="text" class="form-control" id="product-name-edit" v-model="itemDetails.description">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button class="btn btn-primary" data-bs-dismiss="modal">Update Guest Safety</button>
                                        </li>
                                        <li>
                                            <a href="#" class="link" data-bs-dismiss="modal">Cancel</a>
                                        </li>
