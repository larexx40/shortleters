<?php include "header.php"; ?>
    <title>Apartment Categories</title>
</head>
                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Apartment Categories</h3>
                                                <div class="nk-block-des text-soft">
                                                    <p>Here are verious apartment's categories .</p>
                                                </div>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a data-bs-toggle="modal" href="#add-stock"><span>Add Category</span></a></li>
                                    ...
                                    <div class="nk-block">
                                        <div class="card card-bordered card-stretch">
                                            <div class="card-inner-group">
                                                    ...
                                                    <div class="card-search search-wrap" data-search="search">
                                                        <div class="card-body">
                                                            <div class="search-content">
                                                                ...
                                                                <input type="text" class="form-control border-transparent form-focus-none"  @keyup='getAllApartmentCategory(4)' v-model ='search' placeholder="Search by category name or id">
                                                                <button class="search-submit btn btn-icon"><em class="icon ni ni-search"></em></button>
                                                            </div>
                                                        </div>
                                                    </div><!-- .card-search -->
                                                </div><!-- .card-inner -->
                                                <div v-if="apartmentCategories" class="card-inner p-0">
                                                    <div class="nk-tb-list nk-tb-ulist">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div class="nk-tb-col tb-col-md"><span class="sub-text">Apartment</span></div>
                                                        ...
                                                        <div v-for="(item, index) in apartmentCategories" class="nk-tb-item">
                                                            <!-- <div class="nk-tb-col nk-tb-col-check">
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                            ...
                                                            <div class="nk-tb-col">
                                                                <span>{{item.noOfApartment}} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                            </div>
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li @click ='setCategoryid(item.category_id)' v-if='item.noOfApartment > 0'><a data-bs-toggle="modal" href="./apartment_by_category.php"><em class="icon ni ni-eye"></em><span>View Apartments</span></a></li>
                                                                                    <li @click.prevent = 'changeApartmentCategoryStatus(item.category_id, 1)' v-if='item.statusCode == 0 '><a href="#"><em class="icon ni ni-report-profit"></em><span>Set Active</span></a></li>
                                                                                    <li @click.prevent = 'changeApartmentCategoryStatus(item.category_id, 0)' v-if='item.statusCode == 1  ' ><a href="#"><em class="icon ni ni-report-profit"></em><span>Set Inactive</span></a></li>
                                                                                    <li @click.prevent= 'deleteByid(item.category_id)' v-if='item.noOfApartment < 1'><a href="#"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                ...
                                                <div v-if="apartmentCategories" class="card-inner">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="add-stock">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                    <div class="modal-body modal-body-md">
                        <h5 class="modal-title">Add Apartment Category</h5>
                        <form @submit.prevent="addApartmentCategory" class="mt-2">
                            <div class="row g-gs">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-add"> Name</label>
                                        <input v-model="name" type="text" class="form-control" id="product-name-add" placeholder="Category Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button class="btn btn-primary" data-bs-dismiss="modal">Add Category</button>
                                        </li>
                                        <li>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit-stock">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                    <div class="modal-body modal-body-md">
                        <h5 class="modal-title">Edit Apartment Category</h5>
                        <form @submit.prevent="updateApartmentCategory"  action="#" class="mt-2">
                            <div v-if='itemDetails' class="row g-gs">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="product-name-edit">Category Name</label>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button class="btn btn-primary" data-bs-dismiss="modal">Update Category</button>
                                        </li>
                                        <li>
                                            <a href="#" class="link" data-bs-dismiss="modal">Cancel</a>
                                        </li>
