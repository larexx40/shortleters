                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">All Apartment Images Facilities</h3>
                                                <div class="nk-block-des text-soft">
                                                    <p>Here is our various apartments and their respective images.</p>
                                                </div>
                                    ...
                                    <div class="nk-block">
                                        <div class="card card-bordered card-stretch">
                                            <div class="card-inner-group">
                                                    ...
                                                    <div class="card-search search-wrap" data-search="search">
                                                        <div class="card-body">
                                                            <div class="search-content">
                                                                ...
                                                                <input @keyup="getAllApartmentAndImages(4)" v-model="search" type="text" class="form-control border-transparent form-focus-none" placeholder="Search by product name or id">
                                                                <button class="search-submit btn btn-icon"><em class="icon ni ni-search"></em></button>
                                                            </div>
                                                        </div>
                                                    </div><!-- .card-search -->
                                                </div><!-- .card-inner -->
                                                <div v-if="apartments_and_images" class="card-inner p-0">
                                                    <div class="nk-tb-list nk-tb-ulist">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div class="nk-tb-col"><span class="sub-text">Apartment Image</span></div>
                                                            <div class="nk-tb-col tb-col-md"><span class="sub-text">Has Cover Photo</span></div>
                                                        ...
                                                        <div v-for="(item, index) in apartments_and_images" class="nk-tb-item">
                                                            <!-- <div class="nk-tb-col nk-tb-col-check">
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                            ...
                                                            <div class="nk-tb-col">
                                                                <span>{{item.aprtment_name}} <span class="dot dot-success d-md-none ms-1"></span></span>
                                                            </div>
                                                            <div class="nk-tb-col">
                                                                <span class="tb-product"> <img class="thumb" :src="item.details[0].img"></span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md">
                                                                <span v-if="item.has_cover" class="tb-status text-success">{{item.has_cover}}</span>
                                                                <span v-if="!item.has_cover" class="tb-status text-danger">Has no Cover Photo</span>
                                                            </div>
                                                ...
                                                <div v-if="apartments_and_images" class="card">
